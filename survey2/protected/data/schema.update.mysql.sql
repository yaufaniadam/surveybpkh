...
---------------------------------
ALTER TABLE  `<DB_PREFIX>module_settings` ADD  `trigger_condition` VARCHAR(255) NOT NULL DEFAULT '' COMMENT 'includes trigget condition and action' AFTER  `append_text`;
