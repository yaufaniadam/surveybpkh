<?php
    ...
    echo '<br><br>'.$nl;
    if($isSurveyComplete):        
        echo '<input type="submit" class="btn" id="questionnaire-next" value="'.A::t('surveys', 'Finish').'" />'.$nl;
    else:
        echo '<input type="submit" class="btn"'.(!$showButton ? ' style="display:none;"' : '').' id="questionnaire-next" value="'.A::t('surveys', 'Continue').'" />'.$nl;
    endif;
