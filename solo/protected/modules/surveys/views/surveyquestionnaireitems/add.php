<?php
    ...
    $this->_pageTitle = A::t('surveys', 'Questionnaire Items Management').' - '.A::t('surveys', 'Add Questionnaire Item').' | '.CConfig::get('name');
	...
	A::app()->getClientScript()->registerScript(
		'questions-set',
		'questionTypeId_OnChange("frmQuestionnaireAddItem_row_","'.$rowInd.'","'.$selectedValue.'");',
		2
	);
...
<div class="bloc">
	...
	<div class="sub-title">
        ...
        <?= A::t('surveys', 'Add Questionnaire Item') ?>
    </div>
    <div class="content">
    <?php   
        ...
        $fields['question_type_id'] = array('type'=>'select', 'title'=>A::t('surveys', 'Question Type'), 'tooltip'=>'', 'default'=>'', 'validation'=>array('required'=>true, 'type'=>'set', 'source'=>array_keys($questionTypes)), 'data'=>$questionTypes, 'htmlOptions'=>array('onchange'=>'questionTypeId_OnChange(\'frmQuestionnaireAddItem_row_\',\''.$rowInd.'\',this.value)'));
        $fields['variant_text'] = array('type'=>'textarea', 'title'=>A::t('surveys', 'Multiple Answers'), 'tooltip'=>A::t('surveys', 'Multiple Answers Tooltip'), 'default'=>'', 'validation'=>array('required'=>false, 'type'=>'any', 'maxLength'=>1024), 'htmlOptions'=>array('maxLength'=>'1024', 'class'=>'xxlarge'), 'appendCode'=>'<div class="code-example" data-caption="'.A::te('surveys', 'Example of Answers').':"></div>');
        ...
        $fields['sort_order'] = array('type'=>'textbox', 'title'=>A::t('surveys', 'Sort Order'), 'tooltip'=>'', 'default'=>(($maxRecords < 999) ? $maxRecords + 1 : 999), 'validation'=>array('required'=>true, 'type'=>'numeric'), 'htmlOptions'=>array('maxlength'=>'3', 'class'=>'small'));
