<?php
    ...
    $this->_pageTitle = A::t('surveys', 'Survey Questionnaires Management').' - '.A::t('surveys', 'Add Questionnaire').' | '.CConfig::get('name');
    $this->_breadCrumbs = array(
        ...
        array('label'=>A::t('surveys', 'Add Questionnaire')),
    );    
?>
...
<div class="bloc">
	...
	<div class="sub-title">
        ...
        <?= A::t('surveys', 'Add New Questionnaire') ?>
    </div>
    <div class="content">
    <?php   
        ...
        $fields['separator_general']['items_per_page'] = array('type'=>'textbox', 'title'=>A::t('surveys', 'Items Per Page'), 'tooltip'=>'', 'default'=>$itemsPerPage, 'validation'=>array('required'=>true, 'type'=>'range', 'minValue'=>'1', 'maxValue'=>'99'), 'htmlOptions'=>array('maxlength'=>'2', 'class'=>'small'));
        $fields['separator_general']['sort_order']     = array('type'=>'textbox', 'title'=>A::t('surveys', 'Sort Order'), 'tooltip'=>'', 'default'=>(($maxRecords < 999) ? $maxRecords + 1 : 999), 'validation'=>array('required'=>true, 'type'=>'numeric'), 'htmlOptions'=>array('maxlength'=>'3', 'class'=>'small'));
