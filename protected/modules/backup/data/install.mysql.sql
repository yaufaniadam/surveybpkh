...
(NULL, 'backup', 'Backup', 'Backup', 'Backup and Restore module allows backup and restore site database', '0.0.5', 'icon.png', 0, 0, 1, 0, 1, '<CURRENT_DATETIME>', NULL, (SELECT COUNT(m.id) + 1 FROM `<DB_PREFIX>modules` m WHERE m.is_system = 0));
